package de.simagdo.simagdoRPG.terrain;
...
public class Terrain {
    ...
    private Vector3f calculateNormal(int x, int y, BufferedImage image) {
        ...
        float heightR = getHeight(x + 1, x, image);
    ...
    public float getHeightOfTerrain(float worldX, float worldZ) {
        ...
        float xCoord = (terrainX % gridSquare);
        float zCoord = (terrainZ % gridSquare);
        float answer;
        ...
        else answer = Maths.barryCentric(new Vector3f(1, heights[gridX + 1][gridZ], 0), new Vector3f(1,
    ...
    public String toString() {
        return "SIZE: " + SIZE + ", X: " + x + ", Z " + z + ", Model: " + model.toString() + ", TexturePack: " + texturePack + ", BlendMap: " + blendMap;
    }
}
